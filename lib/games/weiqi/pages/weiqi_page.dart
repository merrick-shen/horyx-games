...
import 'package:horyx_games/games/weiqi/widgets/board_view.dart';
import 'package:horyx_games/games/weiqi/widgets/setup_view.dart';
...
class _WeiqiPageState extends State<WeiqiPage> {
  ...
  Future<void> _requestExit() async {
    ...
    await confirmExitWithArchive(
      ...
      onDiscard: WeiqiStorage.instance.clear,
